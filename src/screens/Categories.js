            ...
            <div className='mb-3'>
                <nav class="navbar navbar-light bg-light">
                    <div class="container">
                        ...
                        <form class="d-flex">
                            <input class="form-control me-2 border-warning" type="search" placeholder="Search Category" aria-label="Search" value={search} onChange={(e) => { setSearch(e.target.value) }} />
                            ...
                            <div className="container overflow-hidden mt-2 mb-2">
                                <div className="row gy-5">
                                    <div className="col-12">
                                        <button type='button' className="btn btn-outline-warning p-3 col-md-12" key={data.id} onClick={() => navigate("/categoryexplore", { state: { category: data.CategoryName } })}>{data.CategoryName}</button>
                                    </div>
                                </div>
                            </div>
                        )
